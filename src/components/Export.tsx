  ...
  return (
    <div className="dropdown dropdown-start">
      <div className="tooltip tooltip-bottom" data-tip={t('export.exportData')}>
        <button className="btn btn-sm" tabIndex={0}>
      ...
      <ul className="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52">
        <li>
          <button onClick={handleExportCSV} className="flex items-center gap-2" title={t('export.exportAsCSV')}>
            {t('export.exportAsCSV')}
          </button>
        </li>
        <li>
          <button onClick={handleExportJSON} className="flex items-center gap-2" title={t('export.exportAsJSON')}>
            {t('export.exportAsJSON')}
          </button>
        </li>
        <li>
          <button onClick={handleExportExcel} className="flex items-center gap-2" title={t('export.exportAsExcel')}>
